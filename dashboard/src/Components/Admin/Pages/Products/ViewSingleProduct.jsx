...
function ViewSingleProduct() {
  ...
  const {loadingState, singleProductState,getSingleProductsDetails}  = useContext(createAdminContext);
  ...
  useEffect(()=>{
    ...
    if(cookie.adminToken){
        getSingleProductsDetails(state);
    }
    ...
    <>
      <div className="">
        <div className="shadow-md w-full bg-white p-5">
          <div className="">
            <h1 className="text-2xl text-gray-600 font-bold">Product : <span className="ml-5 text-red-400">{singleProductState.name}</span></h1>
          </div>
        </div>
        {/*  */}
        <div className="">
          ...
          <div className="p-5 flex justify-evenly flex-wrap">
            <div className="shadow-xl w-[100%] md:w-[50%] h-[50%] my-5 p-3">
            ...
            <div className="shadow-xl w-[100%] md:w-[50%] my-5 p-3">
                <div className="px-5 pb-5">
                    ...
                    <div className="flex items-center justify-between flex-wrap my-5">
                        ...
                        <p className="text-2xl font-bold text-gray-900 my-2">Stock : {singleProductState.stock}</p>
                    </div>
                    <div className="flex items-center justify-between flex-wrap my-5">
                    ...
                    <div className="flex items-center justify-between flex-wrap my-5">
                        ...
                        <p className="text-lg text-gray-900 font-medium">Added on : <span className="font-normal">{new Date(singleProductState.createdAt).toLocaleString("en-IN", { timeZone: "Asia/Kolkata" })}</span></p>
                    </div>
                    <div className="flex items-center justify-between flex-wrap my-5">
                    ...
                    <div className="flex flex-col flex-wrap my-5">
                        ...
                        <p className="text-lg text-gray-900 font-medium my-2">Short Description : <span className="font-normal">{singleProductState.short_description}</span></p>
                    </div>
                    <div className="mt-16 border-t-2 border-blue-600">
                        <div className="flex justify-between flex-wrap mt-5">
                            <p className="font-semibold text-xl">Reviews</p>
                            <p>Total reviews : <span className="text-xl font-semibold">{singleProductState.numberOfReviews}</span></p>
                        </div>
                        <div className="">
